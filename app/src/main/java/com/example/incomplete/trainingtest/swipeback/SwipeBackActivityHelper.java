package com.example.incomplete.trainingtest.swipeback;
...
public class SwipeBackActivityHelper {
    ...
    private boolean mScrollStateChangeThemeEnable = true;
    ...
    public void convertActivityFromTranslucent() {
        ...
        if (!mScrollStateChangeThemeEnable) {
            return;
        }

        try {
            Method method = Activity.class.getDeclaredMethod(
                    "convertFromTranslucent", new Class[0]);
    ...
    public void setmScrollStateChangeThemeEnable(boolean mScrollStateChangeThemeEnable) {
        this.mScrollStateChangeThemeEnable = mScrollStateChangeThemeEnable;
    }
}
